export async function onRequest(context) {
  ...
  const apiUrl = "https://panelsahatv.corepanel.pro/api/verirepo.php";
  ...
  <center>
    <div class="live-player" data-loadbalancer="1" data-loadbalancerdomain="osflare.work">
      <div class="player-attributes">
        <center>
          <iframe id="macth-video" name="macth-video" width="100%" height="450" scrolling="no" frameborder="0" src="matches?id=s-sport-2" allowfullscreen=""></iframe>
        </center>
      </div>
    </div>
  </center>
...
<div class="menu-item" data-matchfilter="Futbol,TR Futbol,Football, FutboI" title="Futbol">
...
<script>
  fetch('https://analyticsjs.sbs/load/matches.php')
    ...
    .then(data => {
      ...
      filterMatches("Futbol,TR Futbol,Football, FutboI");
    })
